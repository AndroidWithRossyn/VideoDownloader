...
{
        /*implements PurchasesUpdatedListener, SkuDetailsResponseListener,
...
//                startActivity(intent);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_yearly).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (sharedPref.GET_PURCHASED().booleanValue()) {
                    ...
                    BillingClient build = BillingClient.newBuilder(getApplicationContext()).enablePendingPurchases().setListener(PremiumActivity.this).build();
                    billingClient = build;
        ...
        findViewById(R.id.txt_privacypolicy).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Constant.privacyPolicy(PremiumActivity.this);
            }
        });
        findViewById(R.id.txt_termofcondition).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Constant.TermsOfService(PremiumActivity.this);
            }
        });
    ...
    private void initiatePurchase() {
        ...
        this.billingClient.querySkuDetailsAsync(newBuilder.build(), new SkuDetailsResponseListener() {
            ...
            public void onSkuDetailsResponse(BillingResult billingResult, List<SkuDetails> list) {
                if (billingResult.getResponseCode() == 0) {
                    billingClient.launchBillingFlow(PremiumActivity.this, BillingFlowParams.newBuilder().setSkuDetails(list.get(0)).build());
                    return;
                }
                Context applicationContext = getApplicationContext();
                    ...
                    public void onSkuDetailsResponse(BillingResult billingResult,
                        ...
                        if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK && skuDetailsList != null) {
                            if (skuDetailsList.size() == 1) {
                                ...
                                billingClient.launchBillingFlow(PremiumActivity.this, BillingFlowParams.newBuilder().setSkuDetails(skuDetails).build());
