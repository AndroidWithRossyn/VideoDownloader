...
import com.proxy.video.downloader.BuildConfig;
import com.proxy.video.downloader.MyApplication;
import com.proxy.video.downloader.R;
...
public class LoginDialog extends DialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        carrierIdEditText.setText(prefs.getString(BuildConfig.STORED_CARRIER_ID_KEY, MyApplication.Carrier_Id));
    ...
    void onLoginBtnClick(View v) {
        ...
        if (carrierId.equals("")) carrierId = MyApplication.Carrier_Id;
