...
import com.prox1.video1.download1.databinding.ActivityLikeeBinding;
...
import static com.prox1.video1.download1.util.Utils.RootDirectoryLikee;
    ...
    private void showInterstitial() {
        if (!sharedPref.GET_PURCHASED().booleanValue()) {
            if (mInterstitialAd != null) {
                final ProgressDialog pd = new ProgressDialog(LikeeActivity.this);
