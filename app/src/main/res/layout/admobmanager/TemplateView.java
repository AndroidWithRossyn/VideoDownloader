...
public class TemplateView extends FrameLayout {
    ...
    public String getTemplateTypeName() {
        if (templateType == R.layout.ads_native) {
            return MEDIUM_TEMPLATE;
        } else if (templateType == R.layout.ads_native) {
        ...
        try {
            templateType =
                    attributes.getResourceId(
                            R.styleable.TemplateView_gnt_template_type, R.layout.ads_native);
        } finally {
            attributes.recycle();
        }
    ...
    public void onFinishInflate() {
        ...
        ratingBar = (RatingBar) findViewById(R.id.aal_rb_Rate);
